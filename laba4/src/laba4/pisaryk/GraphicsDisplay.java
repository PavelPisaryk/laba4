...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, new float[]{20,3,10,3,20}, 0.0f);
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            //triangle.moveTo(triangle.getCurrentPoint().getX() - 5, triangle.getCurrentPoint().getY());
            //triangle.lineTo(triangle.getCurrentPoint().getX() + 5, center.getY() + 5);
            //triangle.lineTo(triangle.getCurrentPoint().getX() + 5, triangle.getCurrentPoint().getY() - 5);
            triangle.lineTo(triangle.getCurrentPoint().getX() - 10, triangle.getCurrentPoint().getY() - 20);
            triangle.lineTo(triangle.getCurrentPoint().getX() - 10, triangle.getCurrentPoint().getY() + 20);
